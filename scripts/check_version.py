...
MARKERS = [
    ...
    ("Gram-Schmidt is scale-invariant",
     "vngat/models/vn_layers.py", "PRE-NORMALISE both channels"),
    ...
    ("resume adopts the checkpoint's settings",
     "vngat/training/trainer.py", "def adopt_checkpoint_config"),
    ("schedule restart on resume",
     "vngat/config.py", "restart_schedule"),
    ("restart overrides the checkpoint's base lr",
     "vngat/training/trainer.py", 'group["initial_lr"] = cfg.lr'),
    ...
    ("cosine anneals once, and its horizon is serialised",
     "vngat/training/trainer.py", "class _CosineOnce"),
